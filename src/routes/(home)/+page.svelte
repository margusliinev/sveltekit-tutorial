...
<header class="my-32 w-screen-90 max-w-4xl text-center">
    <h3 class="mx-auto mb-6 w-fit rounded-full border border-white/60 px-7 py-2.5 text-sm font-medium">{currentDate}: We are now in open beta!</h3>
    ...
    <h2 class="text-md mx-auto mt-6 max-w-2xl text-white/80 md:text-lg">
